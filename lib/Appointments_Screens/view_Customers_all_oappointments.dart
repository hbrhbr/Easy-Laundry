...
class Customer_View_All_Appointments extends StatefulWidget {
  final int cust_id;
  final Order_Status obj_status;
  Customer_View_All_Appointments({this.cust_id,this.obj_status});
  @override
  _Customer_View_All_AppointmentsState createState() => _Customer_View_All_AppointmentsState();
}

class _Customer_View_All_AppointmentsState extends State<Customer_View_All_Appointments> {
  ...
  _get_All_orders()async{
    ...
    var response = await http.post(
        K_API_Initial_Address+"appointments/getAllCustomerAppointments",
        headers: headers,
        body: json.encode({
          "customer_id":widget.cust_id,
          "appointment_status":widget.obj_status.order_status_id,
        })
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("${widget.obj_status.status} Appointments"),
      ),
      body: WillPopScope(
        child:
        !is_Loading?
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        appointment_list[index].appointment_status,
                                        style: TextStyle(
                                          fontSize: 10,
                                          color: Colors.black,
                                        ),
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            appointment_list[index].appointment_laundry_name,
                                      ...
                                      // Comment
                                      appointment_list[index].Comment!=null && appointment_list[index].Comment!=""?
                                      Row(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text(
                                          ...
                                          Expanded(
                                            child: Text(
                                              appointment_list[index].Comment,
                                              style: TextStyle(fontSize: 10),
                                            ),
                                          ),
                                        ],
                                      ...
                                      ClipRRect(
                                        ...
                                        child: Container(
                                          ...
                                          child: RaisedButton(
                                            color: Colors.blue,
                                            onPressed: (){
                                              _Rate_Laundry_Owner_Service(appointment_list[index].Laundry_owner_id,appointment_list[index], Controller_Review.text.trim());
                                            },
                                            child: Center(
                                              child: Text(
                                                "Rate",
  ...
  _Rate_Laundry_Owner_Service(int laundry_owner_id,Appointment appointment,String review,)async{
    showDialog(
        barrierDismissible: false,
        context: context,
        builder: (_) =>
    ...
    try {
      ...
      if (data["msg"]=="Rating Added Successfully") {
        ...
        twilioFlutter.sendSMS(
            toNumber: "${appointment.Laundry_Owner_Mobile_no}".trim(),
            messageBody: "${appointment.Customer_name} left a $_rating start review."
        );
      } else
      {
