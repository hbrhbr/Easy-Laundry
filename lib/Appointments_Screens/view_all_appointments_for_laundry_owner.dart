...
class laundry_View_All_customers_Appointments extends StatefulWidget {
  final int laundry_owner_id;
  final Appointment_Status obj_status;
  laundry_View_All_customers_Appointments({this.laundry_owner_id,this.obj_status});
  @override
  _laundry_View_All_customers_AppointmentsState createState() => _laundry_View_All_customers_AppointmentsState();
}

class _laundry_View_All_customers_AppointmentsState extends State<laundry_View_All_customers_Appointments> {
  ...
  _get_All_orders()async{
    ...
    try{
      var response = await http.post(
          K_API_Initial_Address+"appointments/getAppointmentsByStatusAndaundryId",
          headers: headers,
          body: json.encode({
            "laundry_owner_id":widget.laundry_owner_id,
            "appointment_status":widget.obj_status.Appointment_status_id,
          })
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("${widget.obj_status.Appointment_status} Appointments"),
      ),
      body: WillPopScope(
        child:
        !is_Loading?
                              ...
                              leading: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "${appointment_list[index].Customer_name}",
                                      style: TextStyle(
                                        // fontWeight: FontWeight.bold,
                                          fontSize: 10
                                      ),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        appointment_list[index].Category,
                                        style: TextStyle(
                                          fontSize: 10,
                                          color: Colors.black,
                                        ),
                                  ...
                                  widget.obj_status.Appointment_status_id ==4||widget.obj_status.Appointment_status_id==5?
                                  SizedBox() :IconButton(
                                      ...
                                      onPressed: (){
                                        ...
                                        print("Status = ${appointment_list[index].appointment_id}");
                                        setState(() {
                                          selected_status_id = appointment_list[index].appointment_id;
                                                  ...
                                                  ClipRRect(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: RaisedButton(
                                                        color: Colors.blue,
                                                        onPressed: (){
                                                          _Update_Order_Status(widget.laundry_owner_id,appointment_list[index], selected_status_id, is_reject?Controller_Comment.text.trim():"",);
                                                        },
                                                        child: Center(
                                                          child: Text(
                                                            "Update",
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            appointment_list[index].appointment_service_name,
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            appointment_list[index].appointment_qty.toString(),
                                            style: TextStyle(fontSize: 10),
                                          ),
                                        ],
                                      ),
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            appointment_list[index].appointment_price.toString(),
                                            style: TextStyle(fontSize: 10),
                                          ),
                                        ],
                                      ),
  ...
  _Update_Order_Status(int laundry_owner_id,Appointment order,int appointment_status,String comment,)async{
    showDialog(
        barrierDismissible: false,
        context: context,
        builder: (_) =>
    ...
    try {
      ...
      final response = await http.post(
          K_API_Initial_Address + "appointments/updateAppointmentByAppointmentIdAndStatus",
          headers: headers,
          body: json.encode({
            "appointment":{
              "comment": comment,
      ...
      //           "${order.order_service_name} is ${status_list[appointment_status-1].status}. ${order.order_laundry_name}"
      //           :"Dear Customer, Your Order no ${order.order_id} for ${order.Category} of "
      //           "${order.order_service_name}'\s ${status_list[appointment_status-1].status}. ${order.order_laundry_name}");
      // } else
      // {
